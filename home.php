...
<div id="shell">
  <div id="header">
    <h1 id="logo"><a href="#">CUSTOVIEW</a></h1>
    <div class="top-bar">
      <div class="links"> <a href="index.html">LOGOUT</a> </div>
      <div class="cl">&nbsp;</div>
      <div id="search">
  ...
  <div id="navigation">
    ...
    <ul>
      <li><a href="newReview.html">WANA SHARE SOMETHING?</a></li>
    </ul>
	<ul>
      <li><select name="city">
  ...
  <div id="main">
    <div id="content">
      ...
      <div class="box">
        <h2><span>Beauty & Healthcare</span></h2>
        <a href="#" class="see-all">See all articles in this category</a>
        <div class="cl">&nbsp;</div>
        <div class="posts">
          <div class="post">
  ...
  <div id="footer">
    <p class="lf">Copyright &copy; 2016 <a href="http://www.custoview.com">www.custoview.com</a> - All Rights Reserved</p>
